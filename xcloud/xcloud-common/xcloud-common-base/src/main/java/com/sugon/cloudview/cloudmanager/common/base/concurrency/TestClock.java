package com.sugon.cloudview.cloudmanager.common.base.concurrency;
...
public class TestClock extends TimerTask {
    ...
    public TestClock(Scheduler scheduler, int minutesPerHour, int hoursPerDay, int daysPerWeek, int daysPerMonth,
    ...
    public void run() {
        synchronized (this) {
            ...
            if (_scheduler != null) {
                // XXX: Creating new date is hugely inefficient for every
                // minute.
                // Later the time in the database will be changed to
                // currentTimeInMillis.
                // Then we can use System.getCurrentTimeInMillis() which is damn
                // cheap.
