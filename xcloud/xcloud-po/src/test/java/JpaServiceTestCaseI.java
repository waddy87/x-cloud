...
public class JpaServiceTestCaseI {
    ...
    public void testFindProjectByVm(){
    	...
    	// call test method
    	String jpql = "select p from ProjectE p,ProjectVM pv where pv.projectId=p.id and pv.vmId='"+vmId+"'";
    	ProjectE result = (ProjectE) em.createQuery(jpql).getSingleResult();
