...
public class VCenterManageUtils {
	...
	public VCenterManageUtils(Connection conn) {
	//	if(Connection.si==null){
			conn.getSi();
	//	}
		ServiceInstance si=Connection.si;
		this.serverConnection = si.getServerConnection();
	...
	public Alarm getAlarmById(String alarmId)
		...
		try {
			...
			mor.setVal(alarmId);
			Alarm alarm = new Alarm(serverConnection, mor);
			return alarm;
		} catch (Exception e) {
	...
	public VirtualMachine getVirtualMachineById(String vmId)
		...
		try {
			...
			mor.setVal(vmId);
			VirtualMachine vm = new VirtualMachine(serverConnection, mor);
			return vm;
		} catch (Exception e) {
	...
	public ResourcePool getResourcePoolById(String respoolId)
		...
		try {
			...
			ResourcePool respool = new ResourcePool(serverConnection, mor);
			return respool;
		} catch (Exception e) {
	...
	public HostSystem getHostSystemById(String hostId)
		...
		try {
			...
			mor.setVal(hostId);
			HostSystem hostSystem = new HostSystem(serverConnection, mor);
			return hostSystem;
		} catch (Exception e) {
	...
	public Datacenter getDatacenterById(String dcId) throws CloudViewPerfException {
		try {
			...
			mor.setVal(dcId);
			Datacenter dc = new Datacenter(serverConnection, mor);
			return dc;
		} catch (Exception e) {
	...
	public Task getTaskById(String taskId) throws CloudViewPerfException {
		...
		try {
			...
			mor.setType("Task");
			mor.setVal(taskId);
			Task task = new Task(serverConnection, mor);
			return task;
		} catch (Exception e) {
	...
	public TaskInfo getHistoryTaskById(String taskId)
		...
		try {
			TaskManager taskMgr = this.serverConnection.getServiceInstance()
					.getTaskManager();
	...
	public Datastore getDatastoreById(String dsId) throws CloudViewPerfException {
		...
		try {
			...
			mor.setVal(dsId);
			Datastore entity = new Datastore(serverConnection, mor);
			return entity;
		} catch (Exception e) {
