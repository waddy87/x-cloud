// package com.sugon.cloudview.cloudmanager.api;
//
...
// public class RestDesc {
// private static final Logger logger = LoggerFactory.getLogger(RestDesc.class);
//
// @Autowired
...
//
// @RequestMapping(value = "/wadl", method = RequestMethod.GET, produces = {
// "application/xml" })
...
//
// Map<RequestMappingInfo, HandlerMethod> handletMethods =
// handlerMapping.getHandlerMethods();
// for (Map.Entry<RequestMappingInfo, HandlerMethod> entry :
// handletMethods.entrySet()) {
//
...
// wadlDocMethod.setTitle(javaMethod.getDeclaringClass().getSimpleName() + "." +
// javaMethod.getName());
