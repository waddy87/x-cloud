...
/*用户表*/
INSERT INTO `user` (`id`, `create_date`, `email`, `locked`,`org_id`,`org_name`,`password`,`realname`,`salt`,`telephone`,`username`,`is_delete`) VALUES ('1', '2016-3-30 18:29:53', '', '', '', '', 'd3c59d25033dbf980d29554025c23a75', 'admin', '8d78869f470951332959580424d4bf4f', '1234567890', 'admin','');
