package org.waddys.xcloud.resource.serviceImpl.impl.vnet;
...
import org.waddys.xcloud.resource.serviceImpl.dao.entity.vnet.NetPoolE;
import org.waddys.xcloud.resource.serviceImpl.dao.service.vnet.NetPoolDaoService;
import org.waddys.xcloud.resource.serviceImpl.utils.CommonUtils;
import org.waddys.xcloud.resource.serviceImpl.utils.Converters;
...
public class NetPoolServiceImpl implements NetPoolService {
	...
	public void synNetPoolData(String configId, String ip) throws VNetException {
		...
		try {
			...
			if (qanswer != null) {
				...
				List<org.waddys.xcloud.vijava.data.NetPool> cloudvmlstnetPool = qanswer.getNetList();
				...
				for (org.waddys.xcloud.vijava.data.NetPool netPool : cloudvmlstnetPool) {
	...
	public void compareAdd(List<String> cloudvmIds, List<String> dbIds,
			List<org.waddys.xcloud.vijava.data.NetPool> cloudvmlstnetPool, List<NetPool> dblstNetpool,
		...
		for (String cloudvmId : cloudvmIds) {
			for (org.waddys.xcloud.vijava.data.NetPool vijavanetPool : cloudvmlstnetPool) {
