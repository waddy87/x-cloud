...
public class PerfConstants {
    public static final String HISTORY_ONEDAY = "OneDay_History";
    public static final String HISTORY_SEVENDAY = "SevenDay_History";
    public static final String HISTORY_ONEMONTH = "OneMonth_History";
    public static final String HISTORY_ONEYEAR = "OneYear_History";

    public static final String Host_NUMS_ID = "num.hosts.AVERAGE";
    ...
    public static String[] STORAGE_PERF = {
	                                      DISK_READ_ID,  
	                                      DISK_WRITE_ID,  
	                                      DISK_IOPS_READ_ID,
	                                      DISK_IOPS_WRITE_ID, 
