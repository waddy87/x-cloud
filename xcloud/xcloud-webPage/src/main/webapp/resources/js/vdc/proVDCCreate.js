cloudmanager.namespace("proVDCCreate");
cloudmanager.proVDCCreate = {
	addStoragePool:function(){
		...
		if(tag){
			...
			$("#proVDCCreateAddStorageDivId").append("<div name='"+sId+"' id='"+storagePoolId+"' class='list-group-item'><a href='#' onclick='cloudmanager.proVDCCreate.delStoragePool(this)' class='pull-right'><i class='fa fa-times-circle'></i></a>"+sName+"</div>");
		}
	},
